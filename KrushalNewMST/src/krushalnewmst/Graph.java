...
public class Graph {
    ...
    public Graph(int v){
        ...
        for(int i = 0; i<v; i++){
            parent[i] = -1;
            rank[i] = 1;
            //TEACHER WROTE THIS PART WRONG; HE PUT V instead of I.
        }
    }
    //adding an edge
    ...
    public void printMST(ArrayList<Edge>e){
        for(int i = 0; i<e.size(); i++){
            ...
            System.out.println("weight "+e.get(i).weight);
        }
    }
    ...
    public void KMST(){
        ...
        PriorityQueue<>(allEdge.size(),Comparator.comparingInt(o->o.weight));
