 ...
 * @author Stephie
 */
public class DistanceCalculatorApp extends javax.swing.JFrame {

    /**
     * Creates new form DistanceCalculatorApp
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kilometers to Miles");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 0, 0));
        jLabel2.setText("Enter the Kilometers:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        double m;
        m = (Double.valueOf(Kilometers.getText()))/1.6;
        this.Miles.setText("It is "+ m + " miles.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DistanceCalculatorApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
