 ...
 * @author Stephie
 */
public class CircleCalculationApp extends javax.swing.JFrame {

    /**
     * Creates new form CircleCalculationApp
     */
    public CircleCalculationApp() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Circle Calculations");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 51, 51));
        jLabel2.setText("Enter the radius:");
        ...
        jLabel3.setText("Enter the diameter:");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Circumference, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        double r;
        r = Double.valueOf(Radius.getText());
        double d;
        d = Double.valueOf(Diameter.getText());
        double a;
        a = 3.14 * (r * r);
        double c;
        c = 3.14 * d;
        
        this.Area.setText("The area of the circle is " + a + ".");
        this.Circumference.setText("The circumference is " + c + ".");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CircleCalculationApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CircleCalculationApp().setVisible(true);
            }
        });
    }
